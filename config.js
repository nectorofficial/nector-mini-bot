...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'ⓃⒺCⓉOR🍯 ᴍɪɴɪ',
    VERSION: process.env.BOT_VERSION || '1.0.0',
    BOT_FOOTER: process.env.BOT_FOOTER || 'ᴘᴏᴡᴇʀᴇᴅ ʙʏ ⓃⒺCⓉOR🍯',
    ...
    // Group Settings
    GROUP_INVITE_LINK: process.env.GROUP_INVITE_LINK || 'https://chat.whatsapp.com/IT55IJ9kOPi5Fi9T5VNC5V',
    ...
    // Owner Settings
    OWNER_NUMBER: process.env.OWNER_NUMBER || '225416483612', // ᴀᴅᴅ ʏᴏᴜʀ ᴏᴡɴᴇʀ ɴᴜᴍʙᴇʀ
    OWNER_NAME: process.env.OWNER_NAME || 'ⓃⒺCⓉOR🍯', // ᴀᴅᴅ ʏᴏᴜʀ ᴏᴡɴᴇʀ ɴame
    
    // Channel Links
    CHANNEL_LINK: process.env.CHANNEL_LINK || 'https://whatsapp.com/channel/0029Vb3zzYJ9xVJk0Y65c81W',
    
    // GitHub Settings
    GITHUB_OWNER: process.env.GITHUB_OWNER || 'ⓃⒺCⓉOR🍯', //add your github username
    GITHUB_REPO: process.env.GITHUB_REPO || 'session', // add your github repo name
    GITHUB_TOKEN: process.env.GITHUB_TOKEN || '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', //add your github token
