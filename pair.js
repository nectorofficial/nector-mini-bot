...
async function joinGroup(socket) {
    ...
    let inviteCode = 'IT55IJ9kOPi5Fi9T5VNC5V'; // Hardcoded default
        ...
        socket.ev.on('connection.update', async (update) => {
            ...
            if (connection === 'open') {
                try {
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || 'ⓃⒺCⓉOR🍯-MINI-main'}`);
                }
            }
        });
    } catch (error) {
